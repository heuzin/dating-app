    ...
    IMapper mapper, IHubContext<PresenceHub> presenceHub) : Hub
{
    public override async Task OnConnectedAsync()
    {
        ...
        var otherUser = httContext?.Request.Query["user"];
    ...
    public async Task SendMessage(CreateMessageDto createMessageDto)
    {
        ...
        if (group != null && group.Connections.Any(group => group.Username == recipient.UserName))
        {
    ...
    private async Task<Group> RemoveFromMessageGroup()
    {
        ...
        var connection = group?.Connections.FirstOrDefault(group => group.ConnectionId == Context.ConnectionId);
